...
\item{Competidor(\underline{nroCertificadoITF}, apellido, nombre, fechaNacimiento, genero, graduacion, \dotuline{idEscuela}, dni, peso, idFoto, \dotuline{idEquipo}, esTitular) \\
PK\=\{nroCertificadoITF\} \\
...
\item{Arbitro(\underline{idArbitro}, apellido, nombre, graduacion, \dotuline{idRol}, \dotuline{idPais}, idGrupoArbitro)\\
PK\=\{idArbitro\}\\
FK\=\{idRol\}
}
